 ...
 * Class ParamLexer
 *
 * Produces tokens for a param expression. That is an expression that looks as follows:
 * "text:text:text:text"
 *
 * @package Anexia\ParamParser\Lexer
 */
class ParamLexer extends AbstractLexer
{
    ...
    public function getNextToken(): Token
    {
        switch ($this->currentCharacter()) {
            case ':':
                return $this->readSingle(Token::TYPE_COLON);
            case null:
